...
namespace Platformer.Core
{
    ...
    public class MovementController : MonoBehaviour, ICharacterController
    {
        ...
        void FixedUpdate()
        {
            ...
            Velocity = (m_CurrentPosition - m_PreviousPosition) / deltaTime;

            m_Rigidbody2D.MovePosition(m_CurrentPosition);
            m_NextMovement = Vector2.zero;

            CheckCapsuleEndCollisions(deltaTime);
            CheckCapsuleEndCollisions(deltaTime, false);
        }
        ...
        /// <summary>
        /// This moves the character without any implied velocity.  - imply - 암시하다, 의미하다
        /// </summary>
        ...
        /// </summary>
        public void CheckCapsuleEndCollisions(float deltaTime, bool bottom = true)
        {
            ...
            if (bottom)
            {
                ...
                for (int i = 0; i < m_GroundColliders.Length; i++)
                {
                    ...
                    {
                        relativeVelocity -= movingPlatform.Velocity / deltaTime;
                        break;
                    }
                }
