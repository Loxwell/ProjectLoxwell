...
{
    [Condition("Basic/CheckAnimator`")]
    public class CheckAnimator : ConditionBase
    {

        [InParam("animatorStateName")]
        ...
        {
            if (m_hashFullPath == 0)
                m_hashFullPath = Animator.StringToHash(animatorStateName);

            return !string.IsNullOrEmpty(animatorStateName);
        }
